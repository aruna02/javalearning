...
class MouseListenerTest extends JFrame implements MouseMotionListener
{
    Container cntr;
    JTextField txt;
    JTextArea txtarea;
	...
	txtarea.setText("Mouse moved \n");
	txtarea.append("Mouse Dragged \n"+ e.getX()+ " " + e.getY());
    }
    public void mouseDragged(MouseEvent e){
	txtarea.setText("Mouse Dragged \n");
    }
